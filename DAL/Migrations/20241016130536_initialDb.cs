        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePicture_ID = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Portfolio_items_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 10, 16, 16, 5, 35, 159, DateTimeKind.Local).AddTicks(9856)),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Portfolio_images", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Portfolio_images_Portfolio_items_PortfolioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Portfolio_images_PortfolioId",
                table: "Portfolio_images",
                column: "PortfolioId");

            migrationBuilder.CreateIndex(
                name: "IX_Portfolio_items_ProviderId",
